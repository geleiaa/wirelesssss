...
$ iw list   #Mostra informações sobre a interface/placa de rede. 
	     Caso seu chipset suporte os modos, na saida do comando procure algo assim:	
...
_________________________________________________________________________________________________________________________________________________________
 # Quarto passo
 #Depois de identificar o alvo, comece a captura dos pacotes da rede para então pegar o HANDSHAKE
...
_________________________________________________________________________________________________________________________________________________________ 
 ...
 (-0 especifica o Deauthentication attack,   1 é o número de deauths a serem enviados,   -a mac do roteador alvo,   -c mac do dispositivo cliente para
  desautenticar) #Obs: mandar poucos deauths porque pode influenciar na captura do trafego
...
_________________________________________________________________________________________________________________________________________________________
 # Sexto passo
 #Se o Quinto passo for bem sucedido, no terminal do airodump-ng capturando os pacotes
 ...
 # Depois da captura ser feita, voce precisa colocar a interface de volta em modo Managed
...
Nota:  Se for uma senha forte esse ataque é inviável.
       Em caso de duvidas ... 
